...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_PASSWORD_CONFIRM_NOT_MATCH = new ErrorCode(1_004_003_008, "注册失败，两次输入的密码不一致");
    ErrorCode AUTH_USERNAME_USED = new ErrorCode(1_004_003_009, "注册失败，用户名已经被使用");
